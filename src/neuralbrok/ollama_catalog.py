...
KNOWN_LOCAL_MODELS = [
    ...
    {"tag": "qwen2.5-coder:7b", "params_b": 7.62, "vram_gb": 4.9, "capabilities": ['coding', 'chat']},
    {"tag": "qwen2.5-coder:14b", "params_b": 14.7, "vram_gb": 9.7, "capabilities": ['coding', 'chat']},
    ...
    {"tag": "qwen3:30b-a3b", "params_b": 30.5, "vram_gb": 19.0, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "qwen3:235b-a22b", "params_b": 235.0, "vram_gb": 142.0, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "qwen3-coder:30b-a3b", "params_b": 30.5, "vram_gb": 19.0, "capabilities": ['coding', 'agentic', 'chat', 'tools']},
    {"tag": "qwen3-vl:7b", "params_b": 7.6, "vram_gb": 5.3, "capabilities": ['vision', 'reasoning', 'chat', 'tools']},
    ...
    {"tag": "qwen3.5:35b-a3b", "params_b": 35.0, "vram_gb": 23.0, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "qwen3.5:122b-a10b", "params_b": 122.0, "vram_gb": 26.6, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "qwen3.5:397b-a17b", "params_b": 397.0, "vram_gb": 29.2, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    # ── DeepSeek family ───────────────────────────────────────────────────────
    ...
    {"tag": "deepseek-coder-v2:16b", "params_b": 16.0, "vram_gb": 10.2, "capabilities": ['coding', 'chat']},
    # ── Gemma family ──────────────────────────────────────────────────────────
    ...
    {"tag": "gemma4:26b-a4b", "params_b": 26.0, "vram_gb": 15.9, "capabilities": ['reasoning', 'math', 'chat', 'agentic', 'vision', 'tools']},
    {"tag": "gemma4:31b", "params_b": 31.0, "vram_gb": 18.6, "capabilities": ['reasoning', 'math', 'chat', 'agentic', 'vision', 'tools']},
    # ── Phi family ────────────────────────────────────────────────────────────
    {"tag": "phi4-mini:3.8b", "params_b": 3.84, "vram_gb": 3.0, "capabilities": ['reasoning', 'chat', 'coding']},
    ...
    {"tag": "devstral-small:24b", "params_b": 23.6, "vram_gb": 14.9, "capabilities": ['chat', 'agentic', 'coding', 'tools']},
    {"tag": "magistral-small:24b", "params_b": 23.6, "vram_gb": 14.9, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    ...
    {"tag": "deepseek-coder:6.7b", "params_b": 6.74, "vram_gb": 6.0, "capabilities": ['coding', 'chat']},
    # ── Reasoning specialists ─────────────────────────────────────────────────
    {"tag": "smallthinker:3b", "params_b": 3.09, "vram_gb": 2.1, "capabilities": ['reasoning', 'math', 'chat']},
    # ── Other popular models ──────────────────────────────────────────────────
    {"tag": "glm4.7-flash", "params_b": 31, "vram_gb": 18.5, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "gpt-oss:20b", "params_b": 21, "vram_gb": 11.9, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'tools']},
    {"tag": "minimax-m2.1", "params_b": 229, "vram_gb": 138.3, "capabilities": ['reasoning', 'math', 'agentic', 'chat', 'coding', 'tools']},
    ...
    {"tag": "lfm2.5-thinking:1b", "params_b": 1.0, "vram_gb": 0.8, "capabilities": ['reasoning', 'chat']},
]
